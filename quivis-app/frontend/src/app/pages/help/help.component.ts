        ...
        this.answers = [
            {
                ...
                'Frag Claude': 'Hier findest du eine Schnittstelle für das KI-basierte Sprachmodell Claude von Anthropic. Claude, ist ein hochentwickeltes Sprachmodell und verfügt über die Möglichkeit auf Basis der gegebenen medizinischen Historie Ideen, Einschätzungen und Empfehlungen zu geben. Das kann zum Beispiel die Interpretation von Testergebnissen, mögliche Diagnosen oder Behandlungsoptionen sein. Basierend auf deinen Daten kannst du Claude zu Diagnosen, Medikationen o.Ä. befragen. Claude wird dir dann eine Antwort geben, die auf deinen Daten basiert.'
            },
            {
